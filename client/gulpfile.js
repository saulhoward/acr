...
gulp.task('compile', ['compile:deps', 'compile:app', 'compile:style', 'copy:fonts', 'copy:index']);

gulp.task('default', ['compile:deps', 'watch:app', 'watch:style', 'copy:fonts', 'copy:index']);
